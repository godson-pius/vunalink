...
(output / "model_metadata.json").write_text(json.dumps({"name": "VunaLink MobileNetV2", "version": "0.1.0", "format": "saved_model", "dataset": "PlantVillage", "class_count": num_classes, "input": {"width": size[1], "height": size[0], "channels": 3, "dtype": "float32", "color_format": "RGB", "tensor_layout": "NHWC"}, "preprocessing": {"resize": "image_dataset_from_directory target size", "scaling": "mobilenet_v2.preprocess_input", "formula": "(pixel / 127.5) - 1", "channel_order": "RGB", "applied_in_model": True}, "output": {"shape": [None, num_classes], "dtype": "float32", "semantics": "softmax class probabilities"}, "class_mapping": "class_mapping.json", "classes": class_names, "training": config["model"], "best_checkpoint": "best_model.keras"}, indent=2) + "\n")
