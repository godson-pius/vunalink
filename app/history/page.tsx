...
export default function HistoryPage() {
  ...
  const clearHistory = async () => { if (!window.confirm("Clear all saved crop checks from this device?")) return; try { await clearDiagnoses(); setRecords([]); setSelected(null); } catch { setError(true); } };
